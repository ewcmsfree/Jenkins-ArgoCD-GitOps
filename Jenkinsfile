				...
				script {
					kubeconfig(credentialsId: 'k8s-config', serverUrl: 'https://192.168.0.230:6443') {
						sh '''
							...
							argocd app sync argocdjenkins --server 192.168.0.230:30412 --auth-token eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJhcmdvY2QiLCJzdWIiOiJ3dXpoaWp1bjphcGlLZXkiLCJuYmYiOjE3NzEwNjA5NDcsImlhdCI6MTc3MTA2MDk0NywianRpIjoiamVua2lucyJ9.GddAcvHScXQkHVM14BpZcYNuD2dXIRowJDGpDMckTRQ --insecure
						'''
					}
				}
			}
